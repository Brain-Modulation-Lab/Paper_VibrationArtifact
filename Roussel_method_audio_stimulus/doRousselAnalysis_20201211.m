...
cfg=[];
cfg.channel = 'audio_p';
audio_p = ft_selectdata(cfg,Df);

%% performing analysis on channel subsets
electrode_groups = unique(electrode.electrode(ismember(electrode.type,{'ecog','dbs','macro','micro'})));
output_table = table();
...
writetable(output_table,[PATH_ANDATA filesep SUBJECT '_Roussel_method.csv'])
