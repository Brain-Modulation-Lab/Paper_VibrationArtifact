function P10b_time_frequency_plotting(SUBJECT)
...
cfg=[];
cfg.channel = {'macro_*','dbs_*','*audio_*','ecog_*','micro_*'};
...
cont=0;
cont1=0;
name={{'ECoG (154)'}, {'ECoG (255)'}, {'DBS Lead (L1)'},  {'Macro (P)'}, {'Micro (P)'}};
...
for s=[4, 3, 1]
  ...
  session_elec_types = {'dbs','ecog', 'macro', 'micro'};
