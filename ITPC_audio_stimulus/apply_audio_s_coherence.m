function apply_audio_s_coherence(SUBJECT)
% apply_xcorr_audio_s
%
...
PATH_PROTOCOL = 'Z:\Users\busha\Analysis\2020-10-21-audio_s_coherence';
PATH_DATA = 'Z:\DBS';
...
fprintf('audio_s coherence analysis for subject %s \n',SUBJECT)
...
%saving data
writetable(coherence_audio_p, [PATH_ANALYSIS '/data/' SUBJECT '_coherence_audio_s.txt'],'Delimiter','\t');
