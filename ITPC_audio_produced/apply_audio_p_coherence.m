function apply_audio_p_coherence(SUBJECT)
% apply_xcorr_audio_p
%
...
%defining paths
%SUBJECT='DBS4062'; %used for development/debugging
PATH_PROTOCOL = 'Z:\Commits\Vibration_artifacts\2020-08-05-audio_p-coherence';
PATH_DATA = 'Z:\DBS';
